...
Análise das marcas concorrentes diretas da JAM WEAR. Alimenta o item **#4** das [pendências](../../00-gestao/pendencias-e-validacoes.md) e o §4/§12 do [Documento de Marca](../../02-branding/documento-de-marca.md).

## Lista de calibração (◆ proposta, pós-triangulação de pesquisa)

| Marca | Papel | Site |
|-------|-------|------|
| **Army (ArmyBR)** | Incumbente premium a superar ("performance silenciosa") | https://www.armybr.com.br |
| **Mith** | Aspiracional, forte no Sul | https://mithoficial.com.br |
| **Bulking** | Direto (consenso das duas pesquisas) | https://www.bulking.com.br |
| **Thunder God** | Direto, catarinense | https://thundergod.com.br |
| **Insano Extreme** | Adjacente a monitorar (Brusque, premium acessível real) | https://www.insanoextreme.com.br |
...
- Um arquivo por marca conforme os dados chegarem: `army.md`, `mith.md`, etc.
- Uma tabela comparativa consolidada quando as 5 estiverem levantadas.
